...
func StartHTTP() {
	...
	appAppServeMux.HandleFunc("/app/client/device/user/followApp", app.Device.UserFollowApp)
	appAppServeMux.HandleFunc("/app/client/device/user/unFollowApp", app.Device.UserUnFollowApp)
